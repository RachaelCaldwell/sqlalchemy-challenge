...
def home():
    return (
        ...
        f"/api/v1.0/2016-08-23 - Temperature summary for a specified start<br>"
        f"/api/v1.0/2016-08-23/2017-08-23 - Temperature summary for a specified specified start date and end date<br>"
    )
...
# Return a list of the min temp, avg temp, and max temp for a specified start-end range
